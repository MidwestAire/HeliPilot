                ...
                case SENSOR_ID_FAS:
                    switch (_SPort.fas_call) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            send_uint32(SPORT_DATA_FRAME,DATA_ID_CURRENT, (uint16_t)roundf(_battery.current_amps() * 10.0f)); // send current consumption
                            break;
                    }
                ...
                case SENSOR_ID_SP2UR:
                    switch (_SPort.various_call) {
                        case 0 :
                            ...
                            break;
                        case 1:
                            send_uint32(SPORT_DATA_FRAME,DATA_ID_TEMP1, _ap.control_mode); // send flight mode
                            break;
                    }
